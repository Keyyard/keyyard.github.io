        ...
        {trophy.image ? (
          <img
            ...
            style={{
              ...
              filter: hovered ? `drop-shadow(0 0 12px ${trophy.glowColor}99)` : "none",
          ...
          <span style={{
            fontSize: 72,
            lineHeight: 1,
            filter: hovered ? `drop-shadow(0 0 14px ${trophy.glowColor}bb)` : "none",
            transition: "filter 0.18s, transform 0.18s",
  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background: "linear-gradient(135deg, var(--coal, #1A1A1F), var(--obsidian, #0D0D12))",
      ...
      >
        ...
        <div style={{
          ...
          <button onClick={onClose} style={{
            ...
            color: "var(--text-muted, #7A6A55)", fontSize: "0.7rem",
          ...
          {trophy.link && (
            <a
              ...
              style={{ background: `${trophy.glowColor}18`, color: trophy.glowColor, alignSelf: "flex-start" }}
            >
              View →
            </a>
          )}
    ...
    <div style={{
      ...
      <div style={{
        ...
        <a href="/" style={{
          ...
          color: "var(--grass-bright, #78B04A)", textDecoration: "none",
        ...
        <div style={{ flex: 1, textAlign: "center" }}>
          <h1 style={{
            ...
            letterSpacing: "0.1em",
            margin: 0,
            textShadow: "0 0 20px rgba(245,197,66,0.4), 0 2px 0 rgba(0,0,0,0.6)",
          }}>
            🏆 TROPHY CABINET
          </h1>
          <p style={{
          ...
          <div style={{
            ...
            {[30, 70].map((pct, i) => (
              <div key={i} style={{
                ...
                height: 6,
                background: "linear-gradient(to bottom, rgba(0,0,0,0.5), rgba(255,255,255,0.03), rgba(0,0,0,0.5))",
            ...
            {[15, 50, 85].map((pct, i) => (
              <div key={i} style={{
                ...
                transform: "translateY(-50%)",
                width: 14, height: 24,
                background: "linear-gradient(to right, #78B04A44, #A3D97766, #78B04A44)",
              }} />
            ))}
            <div style={{
              ...
              transform: "translateY(-50%)",
              width: 10, height: 44,
              background: "linear-gradient(to bottom, #78B04A, #4A7030, #78B04A)",
              borderRadius: 2,
            }} />
          </div>
          ...
          <div style={{
            ...
            {[15, 50, 85].map((pct, i) => (
              <div key={i} style={{
                ...
                transform: "translateY(-50%)",
                width: 14, height: 24,
                background: "linear-gradient(to left, #78B04A44, #A3D97766, #78B04A44)",
              }} />
            ))}
            <div style={{
